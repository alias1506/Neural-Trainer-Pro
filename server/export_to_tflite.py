...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print("Usage: python export_to_tflite.py <model.pth> <output.tflite> [num_classes]")
        sys.exit(1)
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            print(f"[OK] TFLite created: {output} ({nc} classes)")
            
    except ImportError:
        print("[WARN] onnx2tf not available (dependency conflicts)")
