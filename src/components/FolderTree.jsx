...
export default function FolderTree({ structure, totalFiles: propTotalFiles }) {
    ...
    const calculatedTotalFiles = countFiles(structure.tree.children)
    const displayTotalFiles = propTotalFiles !== undefined ? propTotalFiles : calculatedTotalFiles
